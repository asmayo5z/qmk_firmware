...
#define CTRL_SQ RCTL_T(KC_QUOT)
#define KC_LSPO LSFT_T(KC_LPRN)
#define KC_RSPC RSFT_T(KC_RPRN)
 ...
 * |---------+------+------+------+------+------+------+------+------+------+-------+-------|
 * | Ctr/Esc |   A  |   R  |   S  |   T  |   G  |   M  |   N  |   E  |   I  |   O   | Ctr/' |
 * |---------+------+------+------+------+------+------+------+------+------+-------+-------|
 * | Shift/( |   Z  |   X  |   C  |   D  |   V  |   K  |   H  |   ,  |   .  |   /   |Shift/)|
 * |---------+------+------+------+------+------+------+------+------+------+-------+-------|
 * |     [   | Alt  | Win  | Nav  |Lower |Enter |Space |Raise | Nav  | Win  |  Alt  |  ]    |
 * `----------------------------------------------------------------------------------------'
 */
[_COLEMAK] = LAYOUT_planck_grid(
    KC_TAB,   KC_Q,    KC_W,    KC_F,    KC_P,    KC_B,    KC_J,    KC_L,    KC_U,    KC_Y,    KC_SCLN, KC_BSPC,
    CTRL_ESC, KC_A,    KC_R,    KC_S,    KC_T,    KC_G,    KC_M,    KC_N,    KC_E,    KC_I,    KC_O,    CTRL_SQ,
    KC_LSPO,  KC_Z,    KC_X,    KC_C,    KC_D,    KC_V,    KC_K,    KC_H,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSPC,
    KC_LBRC,  KC_LALT, KC_LGUI, NAVIGATE,LOWER,   KC_ENT,  KC_SPC,  RAISE,   NAVIGATE,KC_RGUI, KC_RALT, KC_LBRC
),
